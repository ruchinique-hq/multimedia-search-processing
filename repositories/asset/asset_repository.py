...
class AssetRepository:
    ...
    def create_asset(self, data: dict, created_by: str) -> Asset:
        ...
        result = self.mongo_repository.insert_one(ASSETS_COLLECTION, data)
        return Asset(**data, id=result.inserted_id)

    def get_asset(self, asset_id: str) -> Asset:
        asset = self.mongo_repository.find_one(ASSETS_COLLECTION, {"_id": ObjectId(asset_id)})
    ...
    def delete_asset(self, asset_id: str) -> bool:
        result = self.mongo_repository.delete_one(ASSETS_COLLECTION, {"_id": ObjectId(asset_id)})
